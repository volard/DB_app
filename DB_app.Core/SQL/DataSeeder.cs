...
public static class DataSeeder
{
    ...
    public static void Seed(SQLContext dbContext)
    {
        ...
        var addresses = new List<Address>()
        {
            ...
            new Address(23, "Москва", "Очаковское шоссе", "2"),
            new Address(24, "Москва", "Зенитчиков", "9"),
            new Address(25, "Москва", "Тихорецкий бульвар", "21"),
            ...
            new Address(69, "Indiana(IN)", "Downey St", "316S"),
            new Address(70, "Maryland(MD)", "Capitol Heights", "823"),
            new Address(71, "Wisconsin(WI)", "15420 Bald Eagle Blvd", "15420"),
            ...
            new Address(76, "Oklahoma(OK)", "Redwood Ave", "522E"),
            new Address(77, "Iowa(IA)", "Fork Hollow Rd", "702N"),
            new Address(78, "Missouri(MO)", "37th Te Ct", "19400E"),
